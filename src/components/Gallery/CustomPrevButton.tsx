...
const CustomPrevButton = ({ onClick }: CustomButtonProps) => (
    <button onClick={onClick} className="custom-prev-button absolute z-1 -left-[25px] bottom-[113px] text-red px-2 py-1 sm:bottom-[135px] sm:-left-[60px] md:bottom-[200px] md:-left-[150px] lg:bottom-[242px] lg:-left-[235px]">
