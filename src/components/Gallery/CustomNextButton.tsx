...
const CustomNextButton = ({ onClick }: CustomButtonProps) => (
    <button onClick={onClick} className="custom-next-button absolute bottom-[113px] z-20 -right-[25px]  text-red px-2 py-1 sm:bottom-[135px] sm:-right-[60px] md:bottom-[200px] md:-right-[150px] lg:bottom-[235px] lg:-right-[250px]">
