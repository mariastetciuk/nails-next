...
const CustomNextButton = ({ onClick }: CustomButtonProps) => (
    <button onClick={onClick} className="custom-next-button absolute -right-[23px] top-[24px] z-[1]  text-red px-2 py-1 sm:-right-[24px] sm:top-[23px] md:-right-[24px] lg:right-[20px]">
