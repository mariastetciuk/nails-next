...
const OrderService = ()=> {
    return (
        <div className="relative border-t border-red border-opacity-40 pt-8">
            ...
            <button type="button" className="block mx-auto  rounded-full bg-red opacity-50 text-white w-[130px] h-[130px] px-5 scale-100 transition-all duration-700 md:w-[150px] md:h-[150px] lg:mr-0 lg:w-[170px] lg:h-[170px] hover:scale-125 lg:absolute lg:right-44 lg:top-6" >
               онлайн запис
            </button>
        </div>
    )
