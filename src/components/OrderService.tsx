...
const OrderService = ()=> {
    return (
        <div className="relative border-t border-red border-opacity-40 pt-8">
            ...
            <Link href={'https://studiya-manikyuru-ta-pedikyuru-beautiful-nails.easyweek.com.ua'}rel="noopener noreferrer" target='_blank' aria-label="ordere servise" className="animate border border-white flex items-center justify-center w-[130px] h-[130px] md:w-[150px] md:h-[150px] lg:w-[170px] mx-auto rounded-full bg-red bg-opacity-50 text-white px-5 transition-all duration-700 lg:m-0 lg:h-[170px] hover:opacity-70 lg:absolute lg:right-44 lg:top-6" >
               online запис
            </Link>
            </div>
        </div>
