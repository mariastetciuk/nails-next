...
const OrderService = ()=> {
    ...
    return (
        <div className="relative border-t border-red border-opacity-40 pt-8">
            ...
            <button type="button" aria-label="ordere servise" onClick={togleModal} className="animate border-1 border-white block w-[130px] h-[130px] md:w-[150px] md:h-[150px] lg:w-[170px] mx-auto rounded-full bg-red opacity-50 text-white px-5 transition-all duration-700 lg:m-0 lg:h-[170px] hover:opacity-70 lg:absolute lg:right-44 lg:top-6" >
               online запис
            </button>
            </div>
