...
export const price: Array<Price> = [
  { id: 1, src: "/price/img1.png", title: "Покриття гель-лаком", description: "Гігієнічний манікюр, покриття гель-лаком та дизайн", price: "500 грн." },
  { id: 2, src: "/price/img8.png", title: "Укріплення", description: "Гігієнічний манікюр, укріплення нігтів гелем, покриття гель-лаком та дизайн", price: "600 грн." },
  ...
  { id: 4, src: "/price/img3.png", title: "Гігієнічний манікюр: жіночий, чоловічий", description: "Апаратний, обрізаний або комбінований", price: "350 грн." },
  { id: 5, src: "/price/img6.png", title: "Гігієнічний  педикюр: жіночий, чоловічий", description: "Апаратна обробка стопи та пальчиків, обрізання нігтів.", price: "450 грн." },
  { id: 6, src: "/price/img5.png", title: "Повний педикюр", description: "Апаратний педикюр, покриття гель-лаком та дизайн", price: "600 грн." },
  { id: 8, src: "/price/img9.jpg", title: "Синхрон: манікюр + педикюр", description: "Kомплексна процедура в чотири руки, манікюр та педикюр всього за 90 хв.", price: "1200 грн." },
  { id: 9, src: "/price/img11.jpg", title: "Медичний педикюр", description: "Апаратна обробка стопи, п'ят, пальців, зачистка натоптишів, мозолів, підрізання нігтів.", price: "450 грн." },
