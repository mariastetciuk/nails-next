...
export const price: Array<Price> = [
  ...
  { id: 2, src: "/price/img2.png", title: "Укріплення", description: "Гігієнічний манікюр, укріплення нігтів гелем, покриття гель-лаком та дизайн", price: "600 грн." },
  ...
  { id: 3, src: "/price/img4.png", title: "Нарощення", description: "Гігієнічний манікюр, нарощення нігтів гелем, покриття гель-лаком, дизайн", price: "800 грн." },
  { id: 4, src: "/price/img3.png", title: "Гігієнічний манікюр", description: "Апаратний, обрізаний або комбінований", price: "350 грн." },
  { id: 5, src: "/price/img6.png", title: "Гігієнічний  педикюр", description: "Апаратна обробка стопи та пальчиків, обрізання нігтів.", price: "450 грн." },
  { id: 7, src: "/price/img7.png", title: "Чоловічий педикюр", description: "Апаратна обробка стопи, п'ят, пальців, зачистка натоптишів, мозолів, підрізання нігтів.", price: "від 450 грн." },
